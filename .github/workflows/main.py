...
def get_access_token():
    ...
    post_url = ("https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wx2b3f28c49bfdc82a&secret=44bc0f06dd4f728aa62b5bd67bf61bdd")
    try:
...
if __name__ == "__main__":
    ...
    for user in users:
        send_message(user, accessToken, city, weather, max_temperature, min_temperature,
                     pipi, lizhi, pop, tips, note_en, note_ch, health_tip, lucky_)
    import time
    time_duration = 3.5
